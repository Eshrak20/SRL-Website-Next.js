              ...
              <div className="w-full md:w-7/12 p-8 md:p-14 overflow-y-auto custom-scrollbar">
                ...
                <div className="prose prose-zinc dark:prose-invert max-w-none">
                  <p className="text-lg md:text-xl text-foreground/80 leading-relaxed font-medium mb-6">
                    This development marks a significant milestone in our
                    journey toward redefining the industry standards of
                    excellence and innovation.
                  </p>

                  <p className="text-muted-foreground leading-relaxed mb-6">
                    Our team has been working tirelessly to ensure that every
                    aspect of this project meets the highest quality
                    benchmarks. By integrating cutting-edge technology with
                    user-centric design, we are creating experiences that
                  ...
                  <blockquote className="border-l-4 border-primary pl-6 py-2 italic text-foreground bg-accent/30 rounded-r-xl mb-6">
                    "Innovation is not just about new tools; it&apos;s about a new
                    mindset that prioritizes the user at every touchpoint.&quot;
                  </blockquote>
                </div>
